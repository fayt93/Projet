...
/* une fonction associee a un bouton 'popup' : */
...
/* Affichage ici, on fait de l'opengl */
static void draw()
{ 
  static char msg[32]="";	
...
/* Ici on fais les calculs, pas d'opengl */
...
int main(int argc, char **argv)
{
	...
	/* Uniquement en 2D*/
	/* En 3D c'est gérer différemment grace à la caméra */
	...
	/* Ouvre une fenetre graphique et fait une boucle infini*/
